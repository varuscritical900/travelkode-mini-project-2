...
const [searchName, setSearchName] = useState('')
  ...
  const filterNameUser = user.filter(userName =>{
      ...
      return userName.destTitle.toLowerCase().includes(searchName.toLowerCase()) 
                        ...
                        <div className="card-body">
                            <div className="row align-items-center">
                                <div className="col-sm-4">
                                    <img style={{ width: 300, height:300}} src={data.photo} alt="logo"/>
                                </div>
                            <div className="col-sm-7">
                                <ul className="list-group">
                                    <li className="list-group-item">Tour Destination: <span className="fw-bold">{data.destTitle}</span></li>
                                    <li className="list-group-item">Country: <span className="fw-bold">{data.email}</span></li>
                                    <li className="list-group-item">Price: <span className="fw-bold">{data.mobile}</span></li>   
                                </ul>
                            </div>
